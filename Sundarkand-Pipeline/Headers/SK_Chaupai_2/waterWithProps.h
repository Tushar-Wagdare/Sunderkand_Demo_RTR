...
{	
	...
	// ******************* full brown part (change with our water color while rising) **********************
	glBegin(GL_TRIANGLE_FAN);
	glColor3f(0.38, 0.243, 0.071);
	...
	{
		glLoadIdentity();
		glTranslatef(xWater / s, yWater / s, zWater - 3.0f);
		...
		for (int j = -500; j <= 500; j += 25)
		{
			...
			circle01.color.g = 0.0f;
			circle01.color.b = 1.0f;
	...
	glEnd();*/
	glLoadIdentity();
	glTranslatef(xWater / s, (1.5f * yWater) / s, zWater - 3.6f);

	for (int j = -500; j <= 500; j += 25)
	{
		struct Circle circle01;
	
		circle01.color.r = 0.4;
		circle01.color.g = 0.525;
		circle01.color.b = 0.624;
		circle01.center.xCoordinate = 12.5f / s + j / s;
		circle01.center.yCoordinate = (-150.0f) / s;
		circle01.angle.from = 0.0f;
		circle01.angle.to = 180.0f;
		circle01.radius.xAxis = 50.0f / s;
		circle01.radius.yAxis = 80.0f / s;
	...
	glLoadIdentity();
	glTranslatef(xWater / s, (1.2f * yWater) / s, zWater - 3.4f);

	for (int j = -500; j <= 500; j += 25)
	{
		struct Circle circle01;
		
		circle01.color.r = 0.0;
		circle01.color.g = 0.345;
		circle01.color.b = 0.608;
		circle01.center.xCoordinate = j / s;
		circle01.center.yCoordinate = (-150.0f) / s;
		circle01.angle.from = 0.0f;
		circle01.angle.to = 180.0f;
	...
	glLoadIdentity();
	glTranslatef(xWater / s, yWater / s, zWater - 3.2f);

	for (int j = -500; j <= 500; j += 25)
	{
		struct Circle circle01;
		
		circle01.color.r = 0.373;
		circle01.color.g = 0.729;
		circle01.color.b = 1.0f;
		
		circle01.center.xCoordinate = 12.50f / s + j / s;
		circle01.center.yCoordinate = (-150.0f) / s;
		circle01.angle.from = 0.0f;
		circle01.angle.to = 180.0f;
		circle01.radius.xAxis = 50.0f / s;
	...
	glLoadIdentity();
	glTranslatef(xWater / s, -(0.2f * yWater) / s, zWater - 3.0f);
	for (int j = -500; j <= 500; j += 25)
	{
		struct Circle circle01;
		
		circle01.color.r = 0.0;
		circle01.color.g = 0.561;
		circle01.color.b = 0.988;
		circle01.center.xCoordinate = j / s;
		circle01.center.yCoordinate = (-150.0f) / s;
		circle01.angle.from = 0.0f;
		circle01.angle.to = 180.0f;
	...
	glLoadIdentity();
	glTranslatef(xWater / s, (1.5f * yWater) / s, zWater - 2.7f);
	...
	glLoadIdentity();
	glTranslatef(xWater / s, (1.2f * yWater) / s, zWater - 2.4f);
	...
	glLoadIdentity();
	glTranslatef(xWater / s, yWater / s, zWater - 2.1f);
	...
	glLoadIdentity();
	glTranslatef(xWater / s, (-0.2f + yWater) / s, zWater -1.8f);
	for (int j = -500; j <= 500; j += 25)
	{
		struct Circle circle01;
