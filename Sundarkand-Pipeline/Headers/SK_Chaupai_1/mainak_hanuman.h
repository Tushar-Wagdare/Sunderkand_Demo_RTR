...
//Hanuman Animation 
GLfloat pss1_xHanuman             = 500.0f;
GLfloat pss1_yHanuman             = 100.0f;
GLfloat pss1_zHanuman             = -100.0f;
GLfloat pss1_rHead                = 0.0f;
GLfloat pss1_rHanuman             = 90.0f;
BOOL pss1_bHead                   = FALSE;
GLfloat pss1_rTail                = 0.0f;
BOOL pss1_bTail                   = FALSE;
BOOL pss1_bHanumanRotate          = TRUE;
GLfloat pss1_rotate_left_leg      = 0.0f;
GLfloat pss1_rotate_right_leg     = 0.0f;
GLfloat pss1_bRotateLeg           = FALSE;
GLfloat pss1_xScaleHanuman        = 1.0f;
GLfloat pss1_yScaleHanuman        = 1.0f;
GLfloat pss1_zScaleHanuman        = 1.0f;
BOOL pss1_sHanuman                = TRUE;
...
void drawHanuman_mainak_for_chaupai_1(void)
{
	glLoadIdentity();
	if (pss1_bHanumanRotate == TRUE)
	{
		glTranslatef(-0.85f + pss1_xHanuman / s, 0.37f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
		glScalef(pss1_xScaleHanuman, pss1_yScaleHanuman, pss1_zScaleHanuman);
		glRotatef(180, 1.0f, 0.0f, 0.0f);
		glRotatef(pss1_rHanuman - 160.0f, 0.0f, 0.0f, 1.0f);
	}
	else
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.0f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
		glScalef(pss1_xScaleHanuman, pss1_yScaleHanuman, pss1_zScaleHanuman);
	}
	...
	if (pss1_bHanumanRotate == TRUE)
	{
		glTranslatef(-0.1f + pss1_xHanuman / s, -0.15f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
		glScalef(pss1_xScaleHanuman, pss1_yScaleHanuman, pss1_zScaleHanuman);
		glRotatef(pss1_rHanuman + pss1_rHead - 50.0f, 0.0f, 0.0f, 1.0f);
	}
	else
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.0f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
		glScalef(pss1_xScaleHanuman, pss1_yScaleHanuman, pss1_zScaleHanuman);
		glRotatef(pss1_rHead, 0.0f, 0.0f, 1.0f);
	}
	//*************************** Hanuman Head ****************
	//**** Face *****
	glBegin(GL_TRIANGLE_FAN);
	...
	if (pss1_bHanumanRotate == TRUE)
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.0f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
		glScalef(pss1_xScaleHanuman, pss1_yScaleHanuman, pss1_zScaleHanuman);
		glRotatef(pss1_rHanuman - 30.0f, 0.0f, 0.0f, 1.0f);
	}
	else
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.0f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
	...
	if (pss1_bHanumanRotate == TRUE)
	{
		glTranslatef(-0.18f + pss1_xHanuman / s, -0.23f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
		glScalef(pss1_xScaleHanuman, pss1_yScaleHanuman, pss1_zScaleHanuman);
		glRotatef(pss1_rHanuman - 65.0f, 0.0f, 0.0f, 1.0f);
	}
	else
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.0f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
	...
	if (pss1_bHanumanRotate == TRUE)
	{
		glTranslatef(-0.1f + pss1_xHanuman / s, -0.13f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
		glScalef(pss1_xScaleHanuman, pss1_yScaleHanuman, pss1_zScaleHanuman);
		glRotatef(pss1_rHanuman - 50.0f, 0.0f, 0.0f, 1.0f);
	}
	else
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.0f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
	...
	if (pss1_bHanumanRotate == TRUE)
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.15f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
		glScalef(pss1_xScaleHanuman, pss1_yScaleHanuman, pss1_zScaleHanuman);
		glRotatef(pss1_rHanuman + pss1_rotate_right_leg, 0.0f, 0.0f, 1.0f);
	}
	else
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.0f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
	...
	if (pss1_bHanumanRotate == TRUE)
	{
		glTranslatef(0.0f + pss1_xHanuman / s, -0.01f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
		glScalef(pss1_xScaleHanuman, pss1_yScaleHanuman, pss1_zScaleHanuman);
		glRotatef(pss1_rHanuman + pss1_rotate_left_leg, 0.0f, 0.0f, 1.0f);
	}
	else
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.0f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
	...
	if (pss1_bHanumanRotate == TRUE)
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.0f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
		glScalef(pss1_xScaleHanuman, pss1_yScaleHanuman, pss1_zScaleHanuman);
		glRotatef(pss1_rHanuman + pss1_rTail - 30.0f, 0.0f, 0.0f, 1.0f);
	}
	else
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.0f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
		glScalef(pss1_xScaleHanuman, pss1_yScaleHanuman, pss1_zScaleHanuman);
		glRotatef(pss1_rTail, 0.0f, 0.0f, 1.0f);
	}
	//************** Draw Tail 1st part ****************
	struct Circle tail01;
	tail01.size.point_size = 7;
	...
	if (pss1_bHanumanRotate == TRUE)
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.06f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
		glScalef(pss1_xScaleHanuman, pss1_yScaleHanuman, pss1_zScaleHanuman);
		glRotatef(pss1_rHanuman, 0.0f, 0.0f, 1.0f);
	}
	else
	{
		glTranslatef(0.0f + pss1_xHanuman / s, 0.0f + pss1_yHanuman / s, -3.0f + pss1_zHanuman / s);
