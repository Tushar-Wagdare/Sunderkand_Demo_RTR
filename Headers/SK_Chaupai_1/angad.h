...
void drawAngad(void)
{
	///////////////////////////////////////////////////TRANSFORMATIONS/////////////////////////////////////////////////////////
	glLoadIdentity();
	glTranslatef(0.30f, -0.050f, -1.5f);
	...
	GLfloat s = 100.0f;
		...
		glBegin(GL_TRIANGLE_FAN);
		glColor3f(0.988f, 0.761f, 0.012f);
		glVertex3f(7.50546f / s, 36.2637f / s, 0.0f);
		glVertex3f(13.7685f / s, 36.6911f / s, 0.0f);
		glVertex3f(-0.03961f / s, 36.7296f / s, 0.0f);
		glVertex3f(0.256883f / s, 33.087f / s, 0.0f);
		glVertex3f(5.38765f / s, 33.0022f / s, 0.0f);
		glVertex3f(5.98063f / s, 32.1551f / s, 0.0f);
		glVertex3f(6.70069f / s, 31.3503f / s, 0.0f);
		glVertex3f(7.84431f / s, 31.2656f / s, 0.0f);
		glVertex3f(8.8185f / s, 31.901f / s, 0.0f);
		glVertex3f(9.36913f / s, 33.0446f / s, 0.0f);
		glVertex3f(13.0254f / s, 33.087f / s, 0.0f);
		glVertex3f(13.7685f / s, 36.6911f / s, 0.0f);
		glEnd();
